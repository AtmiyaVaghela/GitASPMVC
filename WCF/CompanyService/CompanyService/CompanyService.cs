...
namespace CompanyService
{
    ...
    public class CompanyService : ICompanyPublicService, ICompanyConfidentialService
    {
        ...
        {
            return "This is public information and available over HTTP to all general public outside of firewall";
        }

        public string GetConfidentialInformation()
        {
            return "This is confidential information and availble over TCP behind the company FireWall";
        }

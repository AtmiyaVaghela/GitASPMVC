namespace ContosoUniversity.Migrations
{
    ...
    public partial class inheritance : DbMigration
    {
        ...
        {
            //drop foreign key and indexes that pointto table we're going to drop.
            ...
            //copy existaning student data into new person table.
            ...
            //remove temporaray key
            DropColumn("dbo.Person", "OldId");

            DropTable("dbo.Student");

            //Re-Create foreign keys and indexed pointing to new table.
